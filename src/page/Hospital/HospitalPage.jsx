  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Hero Banner */}
        <section className="relative bg-gray-900 h-60 text-white py-16 m-6 rounded-2xl">
          <img src="/hospital.jpg" alt="sampling" className="absolute inset-0 object-cover w-full h-full opacity-60 rounded-lg" />
        </section>

        {/* Main Content */}
        <main className="px-4 py-16 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-0">
