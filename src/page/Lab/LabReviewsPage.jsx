...
export default function LabReviewsPage() {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="mx-auto px-4 py-4 text-left">
                ...
                <Breadcrumb className="text-xs text-gray-600">
                    <BreadcrumbList className={"gap-1"}>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/labs/details">Reviews</BreadcrumbLink>
                        </BreadcrumbItem>
                        {/* <BreadcrumbSeparator />
                        <BreadcrumbItem>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 md:py-6">
          <div className="bg-white rounded-md w-10 h-10 flex items-center justify-center mb-6 cursor-pointer">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-96 bg-orange-100 rounded-lg p-8 flex flex-col items-center justify-center h-fit">
            <div className="text-5xl font-normal text-gray-900 mb-4">
              {ratingStats.average}
            </div>
            <div className="flex gap-1 mb-1">
              {renderStars(4, 5)}
            </div>
            <div className="text-lg font-normal text-gray-900 mb-8">
