    ...
    <div className="relative w-full bg-slate-900 py-16 md:py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* Left card */}
          <div className="border-l-2 border border-white my-3 rounded-bl-2xl rounded-tl-2xl p-4 md:p-6 text-left">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
                <Button className="px-6 py-2 bg-white text-sky border border-sky hover:bg-sky/90 hover:text-white transition-colors">
                Learn more
                </Button>
        ...
        <div className="relative max-w-md">
            <div className="absolute inset-0 rounded-lg overflow-hidden">
                {/* use the image as a background so the button can blend / blur over it */}
                <div
                ...
                {/* cut-out style button:
                    - transparent fill
                    - semi-opaque white border
                    - backdrop blur so the border visually blends with the image underneath
                    - mix-blend-mode to help the border blend with underlying colors
                */}
                <button
                    aria-label="Open"
