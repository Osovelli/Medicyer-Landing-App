...
export function PrescriptionUpload({ onUpload }) {
  return (
    <div className="flex flex-col gap-4">
     <div className="bg-[#F0D869] h-80 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
            <div className="relative z-10 text-sky  text-left max-w-xs">
              ...
              <Button 
              variant="soft" 
              className="w-full md:w-auto bg-[#252B61] text-white shrink md:px-12 py-3 rounded-md font-semibold transition"
              >
                Upload
              </Button>
            </div>
