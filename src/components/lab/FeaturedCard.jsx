  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-[170px] md:h-[190px] lg:h-[200px] overflow-hidden">
        ...
        {/* Badge overlay */}
        {badgeLabel && (
          <span className="absolute bottom-3 left-3 flex items-center gap-1.5 bg-green-600 text-white text-[11px] font-semibold tracking-wide px-2.5 py-1.5 rounded-[10px] shadow-[0_2px_8px_rgba(34,168,83,0.35)]">
            <FlaskConical className="w-[10px] h-[10px]" />
            {badgeLabel}
          </span>
        )}
      </div>
